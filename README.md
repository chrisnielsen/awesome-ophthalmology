...
### Generative Models
---
* 2021 - A Bioinspired Approach-Sensitive Neural Network for Collision Detection in Cluttered and Dynamic Backgrounds (Huang et al.) [(paper)](http://arxiv.org/pdf/2103.00857v1.pdf) 
* 2021 - A Bioinspired Retinal Neural Network for Accurately Extracting Small-Target Motion Information in Cluttered Backgrounds (Huang et al.) [(paper)](https://arxiv.org/pdf/2103.00848v1.pdf) 
* 2021 - AI Fairness via Domain Adaptation (Joshi et al.) [(paper)](https://arxiv.org/pdf/2104.01109v1.pdf) 
* 2021 - Biometrics in the Era of COVID-19: Challenges and Opportunities (Gomez-Barrero et al.) [(paper)](https://arxiv.org/pdf/2102.09258v1.pdf) 
...
* 2020 - Synergistic effect in two-phase laser procedure for production of silver nanoparticles colloids applicable in ophthalmology (Nikolov et al.) [(paper)](http://arxiv.org/pdf/2007.13485v1.pdf) 
...
* 2019 - Center of circle after perspective transformation (Wang et al.) [(paper)](http://arxiv.org/pdf/1902.04541v1.pdf) 
...
* 2019 - Predicting synchronous firing of large neural populations from sequential recordings (Sorochynskyi et al.) [(paper)](http://arxiv.org/pdf/1904.04544v1.pdf) 
* 2019 - Reconstruction of Natural Visual Scenes from Neural Spikes with Deep Neural Networks (Zhang et al.) [(paper)](https://arxiv.org/pdf/1904.13007v2.pdf) 
...
* 2018 - Learning to Find Eye Region Landmarks for Remote Gaze Estimation in Unconstrained Settings (Park et al.) [(paper)](http://arxiv.org/pdf/1805.04771v1.pdf) [(code)](https://github.com/Joey0094/GazeML_torch)
* 2018 - Presentation Attack Detection for Iris Recognition: An Assessment of the State of the Art (Czajka et al.) [(paper)](http://arxiv.org/pdf/1804.00194v3.pdf) 
* 2017 - Anti-Glare: Tightly Constrained Optimization for Eyeglass Reflection Removal (Sandhan et al.) [(paper)](http://openaccess.thecvf.com/content_cvpr_2017/papers/Sandhan_Anti-Glare_Tightly_Constrained_CVPR_2017_paper.pdf) 
* 2017 - Derivatives and Inverse of Cascaded Linear+Nonlinear Neural Models (Martinez-Garcia et al.) [(paper)](http://arxiv.org/pdf/1711.00526v3.pdf) 
...
* 2017 - Nilpotent Approximations of Sub-Riemannian Distances for Fast Perceptual Grouping of Blood Vessels in 2D and 3D (Bekkers et al.) [(paper)](http://arxiv.org/pdf/1707.02811v2.pdf) 
...
* 2016 - A tractable method for describing complex couplings between neurons and population rate (Gardella et al.) [(paper)](http://arxiv.org/pdf/1606.08889v1.pdf) 
* 2016 - Bayesian latent structure discovery from multi-neuron recordings (Linderman et al.) [(paper)](http://arxiv.org/pdf/1610.08465v1.pdf) 
* 2015 - Supervised learning sets benchmark for robust spike detection from calcium imaging signals (Theis et al.) [(paper)](http://arxiv.org/pdf/1503.00135v1.pdf) 
...
* 2021 - The Biot-Stokes coupling using total pressure: formulation, analysis and application to interfacial flow in the eye (Ruiz-Baier et al.) [(paper)](http://arxiv.org/pdf/2106.09191v2.pdf) 
...
* 2020 - Retinal blood flow reversal in out-of-plane vessels imaged with laser Doppler holography (Puyo et al.) [(paper)](http://arxiv.org/pdf/2008.09813v1.pdf) 
* 2019 - AxoNet: an AI-based tool to count retinal ganglion cell axons (Ritch et al.) [(paper)](http://arxiv.org/pdf/1908.02919v1.pdf) 
* 2019 - Bayesian Non-Parametric Factor Analysis for Longitudinal Spatial Surfaces (Berchuck et al.) [(paper)](http://arxiv.org/pdf/1911.04337v1.pdf) 
...
* 2018 - Bayesian Semiparametric Functional Mixed Models for Serially Correlated Functional Data, with Application to Glaucoma Data (Lee et al.) [(paper)](http://arxiv.org/pdf/1802.08727v2.pdf) 
...
* 2017 - A Theoretical Study of Aqueous Humor Secretion Based on a Continuum Model Coupling Electrochemical and Fluid-Dynamical Transmembrane Mechanisms (Sala et al.) [(paper)](http://arxiv.org/pdf/1712.03229v1.pdf) 
* 2017 - Estimated Incidence of Ophthalmic Conditions Associated with Optic Nerve Disease in Middle Tennessee (Chaganti et al.) [(paper)](http://arxiv.org/pdf/1712.01481v1.pdf) 
* 2016 - Predicting Glaucoma Visual Field Loss by Hierarchically Aggregating Clustering-based Predictors (Higaki et al.) [(paper)](http://arxiv.org/pdf/1603.07094v1.pdf) 
* 2015 - Bayesian Hierarchical Modeling of Longitudinal Glaucomatous Visual Fields using a Two-Stage Approach (Bryan et al.) [(paper)](http://arxiv.org/pdf/1502.03979v1.pdf) 
...
---
* 2021 - Anomalous angiogenesis in retina (Vega et al.) [(paper)](http://arxiv.org/pdf/2104.00644v1.pdf) 
* 2020 - A Simultaneous Inference Procedure to Identify Subgroups from RCTs with Survival Outcomes: Application to Analysis of AMD Progression Studies (Wei et al.) [(paper)](http://arxiv.org/pdf/2003.10528v1.pdf) 
...
* 2020 - Development and Validation of a Novel Prognostic Model for Predicting AMD Progression Using Longitudinal Fundus Images (Bridge et al.) [(paper)](https://arxiv.org/pdf/2007.05120v1.pdf) 
...
* 2019 - A Parametric Perceptual Deficit Modeling and Diagnostics Framework for Retina Damage using Mixed Reality (Aniruddha et al.) [(paper)](https://arxiv.org/pdf/1910.07688v1.pdf) 
* 2019 - Copula-based Semiparametric Regression Method for Bivariate Data under General Interval Censoring (Sun et al.) [(paper)](http://arxiv.org/pdf/1901.01918v2.pdf) 
* 2019 - Gene-based Association Analysis for Bivariate Time-to-event Data through Functional Regression with Copula Models (Wei et al.) [(paper)](http://arxiv.org/pdf/1904.01116v1.pdf) 
...
* 2017 - Wilcoxon Rank-Based Tests for Clustered Data with R Package clusrank (Jiang et al.) [(paper)](http://arxiv.org/pdf/1706.03409v1.pdf) 
* 2016 - Bayesian aggregation of average data: An application in drug development (Weber et al.) [(paper)](http://arxiv.org/pdf/1602.02055v2.pdf) 
