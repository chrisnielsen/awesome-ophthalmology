...
* 2020 - SA-UNet: Spatial Attention U-Net for Retinal Vessel Segmentation (Guo et al.) [(paper)](https://arxiv.org/ftp/arxiv/papers/2004/2004.03696.pdf) [(code)](https://github.com/clguo/SA-UNet) 
...
* 2019 - Accurate Retinal Vessel Segmentation via Octave Convolution Neural Network (Fan et al.) [(paper)](https://arxiv.org/pdf/1906.12193v8.pdf) [(code)](https://github.com/koshian2/OctConv-TFKeras) 
...
* 2019 - Dynamic Deep Networks for Retinal Vessel Segmentation (Khanal et al.) [(paper)](https://arxiv.org/pdf/1903.07803v2.pdf) [(code)](https://github.com/sraashis/deepdyn) 
...
* 2018 - Deep Vessel Segmentation By Learning Graphical Connectivity (Shin et al.) [(paper)](https://arxiv.org/pdf/1806.02279v1.pdf) [(code)](https://github.com/syshin1014/VGN) 
* 2018 - LadderNet: Multi-path networks based on U-Net for medical image segmentation (Zhuang) [(paper)](https://arxiv.org/pdf/1810.07810v4.pdf) [(code)](https://github.com/juntang-zhuang/LadderNet) 
* 2018 - Recurrent Residual Convolutional Neural Network based on U-Net (R2U-Net) for Medical Image Segmentation (Alom et al.) [(paper)](https://arxiv.org/ftp/arxiv/papers/1802/1802.06955.pdf) [(code)](https://github.com/LeeJunHyun/Image_Segmentation) 
...
* 2017 - Retinal Vessel Segmentation in Fundoscopic Images with Generative Adversarial Networks (Son et al.) [(paper)](https://arxiv.org/pdf/1706.09318v1.pdf) [(code)](https://github.com/ChengBinJin/V-GAN-tensorflow) 
* 2015 - U-Net: Convolutional Networks for Biomedical Image Segmentation (Ronneberger et al.) [(paper)](https://arxiv.org/pdf/1505.04597v1.pdf) [(code)](https://github.com/zhixuhao/unet) 
